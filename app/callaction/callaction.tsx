...
function Callaction() {
  return (
    <div className='w-full h-[190px] bg-gradient-to-r from-[#112748] to-[#295FAE] justify-center items-center py-[40px]'>
        ...
        <div className='2xl:w-[1480px] lg:w-[1000px] h-[120px] border border-white rounded-lg justify-center items-center ml-[72px]'>
            <div className='w-[450px] h-[50px] bg-gradient-to-r from-[#1C3B68] to-[#1B4A92] justify-center items-center 2xl:ml-[500px] lg:ml-[265px] mt-[-20px] py-[10px]'>
            ...
            <div className='mt-[10px] 2xl:ml-[220px]'>
                <Dialog>
