            ...
            <div className="bg-cover grid grid-cols-1">
                ...
                <div className="mt-[30px] ml-[10px] sm:ml-[50px] grid grid-row-3 gap-1 md:w-[80%]">
                    <div>
                        ...
                        <p className='ml-[80px] font-light text-xs md:text-sm'> Bonjour. Le CRFIM offre-t-il des formations en sécurité maritime ?</p>
                    ...
                    <div className='ml-[10px] sm:ml-[50px] mt-1'>
                      ...
                      <p className='ml-[80px] font-light text-xs md:text-sm'>Oui, le CRFIM propose des programmes de formation et de renforcement des capacités pour les acteurs régionaux impliqués dans la sécurité maritime, y compris les forces de l'ordre, les autorités portuaires et d'autres parties prenantes. </p>
                      <p className='mt-[50px] ml-[80px] font-light text-xs'>26/07/23</p>
                        <div className='grid grid-cols-2 grid-flow-row mt-[-15px] ml-[400px]'>
                            <div>
                                <p className='font-light text-xs hover:text-sky-600'>répondre</p>
                        ...
                        <div key={index} className="mb-4 mt-[50px]">
                            ...
                            {/*Photo de Profil*/}
                                ...
                                {/*Photo de Profil*/}
                                    ...
                                    {/* Titre */}
                                    <p className='ml-[80px] mt-[-60px] font-bold text-xs md:text-sm'>Crfim_madagascar</p>
                                    <p className='ml-[80px] font-light text-xs md:text-sm'>Le CRFIM vous répondra dans les plus brefs délais</p>
                                    <p className='mt-[50px] ml-[80px] font-light text-xs'>27/07/23</p>
                                    {/* Action */}
                ...
                <div className="mt-4 flex">
                    <div className="flex w-full items-center sm:space-x-2">
                        <input
                            ...
                            className="sm:ml-[10px] sm:ml-[50px] 2xl:w-[1400px] lg:w-[900px] p-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
                        />
                        <button
                            type="submit" 
