...
function Ressource() {
  return (
    <div>
        <div className='ml-[40px] w-[1000px] h-[600px] bg-gradient-to-r from-[#5DB4D9] to-[#181C70] justify-center items-center py-[10px]'>
            ...
            <div className='grid grid-rows-3'>
              ...
              <div className='grid grid-rows-1 grid-flow-col ml-[20px] mt-[15px]'>
                <div className='w-[450px]'>
                  {/*Text*/}
