...
function Formulaire() {
  ...
  const handleImageChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    const Texte = [
      `${t("formulaire.Bienvenue sur la section de déposition d'information du CRFIM")}`,
      `${t("formulaire.Si vous avez quelconque information à votre disposition qui vous semble pourrait nous être utile (  pêche illégale, entrées et sorties des bateaux, trafics, tourisme, et plus encore, veuillez la déposer ici")}`
    ]
      return (
              ...
              <div className="grid grid-cols-2 grid-flow-row ">
                <div className="mr-1">
                  ...
                  <div className="grid grid-cols-2 grid-flow-row space-y-2 mb-4">
                    <div className="mr-1">
                      <LabelInputContainer>
                        <Label htmlFor="nom">{t("formulaire.Nom")}</Label>
                ...
                <div>
                  {/* fonction à message */}
                  <LabelInputContainer className="mb-4">
                    <Label htmlFor="fonction">{t("formulaire.Votre fonction")}</Label>
                    <Input
                      id="fonction"
                      placeholder={t("formulaire.Personnel du ministère de la pêche")}
                      type="text"
                      value={fonction} onChange={(e) => setFonction(e.target.value)}
                    />
                  </LabelInputContainer>
                  <LabelInputContainer className="mb-4">
                    <Label htmlFor="message">{t("formulaire.Votre Message")}</Label> 
                    <Input id="message" type="textarea" placeholder={t("formulaire.Votre message ici...")} value={message} onChange={(e) => setMessage(e.target.value)}/>
                  </LabelInputContainer>
                  <LabelInputContainer className="mb-3">
                    <Label htmlFor="Photos">{t("formulaire.Importer une photo")}</Label>
