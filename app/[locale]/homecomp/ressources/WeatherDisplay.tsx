        ...
        <div className="md:grid grid-cols-3 grid-flow-row gap-2 items-center">
          <div>
            <img
              ...
              // className="w-16 h-12"
            />
            <p className="text-[11px] mb-1 text-white font-bold">{weather.description}
          ...
          <div className="mr-1">
            <p className="text-[11px] mb-1 font-semibold">
              {t("ressources.Température")} {main.temp} °C
              {/* {main.temp} °C */}
            </p>
            <p className="text-[11px] mb-1 font-semibold">
              {t("ressources.Température Max")} {main.temp_max} °C
              {/* {main.temp_max} °C */}
            </p>
            <p className="text-[11px] mb-1 font-semibold">
              {t("ressources.Température Min")} {main.temp_min} °C
              {/* {main.temp_min} °C */}
            </p>        
          </div>
          ...
          <div>
            <p className="text-[11px] mb-1 font-semibold">
              {t("ressources.Humidité")} 
              {main.humidity} %
            </p>
            <p className="text-[11px] mb-1 font-semibold">
              {t("ressources.Vitesse du vent")} 
              {wind.speed} m/s
            </p>
            <p className="text-[11px] mb-1 font-semibold">
              {formattedDate}
