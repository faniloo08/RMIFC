...
function Ressource() {
  ...
  const Texte = [
    `${t("ressources.Le front axé au Centre et Sud de l'océan Indien")}`,
    `${t("ressources.Cette carte interactive présente notre zone de couverture, qui englobe la partie sud-est de l'Océan Indien. Vous pouvez explorer les différentes zones d'intérêt, les routes maritimes clés, ainsi que les points critiques de surveillance.")}`,
    "",
    `${t("ressources.Trouvez toutes les activités des vaisseaux repertoriés ici.")}`,
    `${t("ressources.Nous vous garantissons des informations à jours et fiables concernants toutes activités des vaisseaux dans la zone de l'Océan Indien et bien plus. En collaboration avec des ressources officiels comme Vesselfinder ou la plateforme du 'Sea Vision', nous ne communiquons que les informations vérifiés par une communauté d'experts.")}`,
    "",
    `${t("ressources.Weather Forecast")}`
  ];
    ...
    <div className="flex items-center justify-center">
      <div className="w-[85%] 2xl:h-[700px] lg:h-[600px] bg-gradient-to-r from-[#5DB4D9] to-[#181C70] justify-center items-center py-[10px]">
        <HeroHighlight>
          ...
          >
            {t("ressources.Des données")}
            <Highlight className="text-black dark:text-white">
              {t("ressources.fiables et à jour.")}
            </Highlight>
          </motion.h1>
        </HeroHighlight>
        <div className="grid grid-rows-3 grid-flow-col">
          ...
          <div className="grid grid-cols-2 grid-flow-row gap-1 mt-[0px]">
            <div className="ml-[20px]">
              <h3 className="font-bold text-[16px] mb-1 hover:text-blue-700">
                {t("ressources.Weather Data")}
              </h3>
              <p className="text-[11px] mb-1">
                {t("ressources.Type the city you want to know the weather of")}
              </p>
            ...
            <div className="">
              ...
              {weather ? (
                ...
                <p className="text-center text-[11px]">
                  {t("ressources.No weather data available.")}
                </p>
              )}
            </div>
          </div>
