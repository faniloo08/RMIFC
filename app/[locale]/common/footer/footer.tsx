...
function Footer() {
  ...
  const Apropos = [
    `${t("A propos.Historique")}`,
    `${t("A propos.Missions et Valeurs")}`,
    `${t("A propos.Objectifs")}`
  ]
  const Mentions = [
    "",
    `${t("Mentions légales.Informations sur les droits d'auteurs")}`,
    `${t("Mentions légales.Politiques de Confidentialité")}`,
  ...
  const Liens = [
    `${t("Liens.CFIM")}`,
    `${t("Liens.Météorologie")}`,
    `${t("Liens.Primature Malgache")}`
  ]
  return (
    <div className="w-full md:h-[308px] bg-gradient-to-r from-[#163583] to-[#4FFFAA] justify-center items-center py-[30px]">
      ...
      <div className=" ml-[20px] 2xl:ml-[120px] lg:ml-[60px] mt-[35px] grid md:grid-rows-1 md:grid-flow-col">
        <div className="grid grid-rows-4 grid-flow-col mb-1">
          <div>
            <p className="text-white text-xs md:text-md font-bold mt-[-5px] relative mb-[5px]">{t("footer.A propos")}</p>
          </div>
          <div>
        ...
        <div className='mb-1'>
          <div>
            <p className="text-white text-xs md:text-md font-bold mt-[-5px] relative mb-[7px]">{t("footer.Contact")}</p>
          </div>
          <div>
        ...
        <div className='mb-1'>
          <div>
            <p className="text-white text-xs md:text-md font-bold mt-[-5px] relative mb-[7px]">{t("footer.Liens")}</p>
          </div>
          <div>
      ...
      <p className="text-xs text-white text-center mt-[25px] border-t pt-1">©2024, RFIMC Inc. {t("footer.Tous droits réservés")}</p>    
    </div>
  )
}
